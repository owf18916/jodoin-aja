...
class ReceivableImportJob implements ShouldQueue
{
    ...
    {
        try {
            $import = new ReceivableImport($this->userId);
            ...
            if (!empty($errors)) {
                ...
                try {
                    DB::table('receivables')->insert($import->getValidRows());
            ...
            Log::error('ReceivableImportJob failed during processing', [
