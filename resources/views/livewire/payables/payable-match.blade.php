<button
    x-on:click="$dispatch('confirmation-fired', {
        eventName: `{{ 'match-payable-executed' }}`,
        message: 'Apakah Anda yakin ingin melakukan matching dokumen payable ? Data payable akan dicocokkan dengan ketersediaan dokumen scan payable'
    })"
