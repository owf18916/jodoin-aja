        ...
        <div class="grid grid-cols-12 gap-2">
            <div class="col-span-12">
                ...
                <x-tom
                    ...
                    @set-supplier-payable-edit.window="
                        $el.supplierField.clear();
                        $el.supplierField.clearOptions();
                        $el.supplierField.addOptions(event.detail.data);
                        $el.supplierField.addItem(event.detail.id);"
