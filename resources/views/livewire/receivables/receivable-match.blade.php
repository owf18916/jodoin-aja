<button
    x-on:click="$dispatch('confirmation-fired', {
        eventName: `{{ 'match-receivable-executed' }}`,
        message: 'Apakah Anda yakin ingin melakukan matching dokumen receivable ? Data receivable akan dicocokkan dengan ketersediaan dokumen scan receivable & bl'
    })"
