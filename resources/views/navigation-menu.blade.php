        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link href="{{ route('payable.index') }}" :active="request()->routeIs('payable.index')" wire:navigate>
                        Payable Document
                    </x-nav-link>
                    <x-nav-link href="{{ route('receivable.index') }}" :active="request()->routeIs('receivable.index')" wire:navigate>
                        Receivable Document
                    </x-nav-link>
